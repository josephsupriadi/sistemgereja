...
<div class="card">
	...
	<div class="card-body">
		<form id="form-update-jemaat" method="post" action="<?=site_url('jemaat/update')?>"enctype="multipart/form-data">
			<div class="form-group">
				...
				<input require type="text"value="<?=$jemaat->nomor_keluarga?>" class="form-control" name="nomor_keluarga">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input require type="text"value="<?=$jemaat->jenis_kelamin_jemaat?>" class="form-control" name="jenis_kelamin_jemaat">
			</div>
			<div class="form-group">
	...
	<div class="card-footer">
		<button type="button" id="btn-update-jemaat" class="btn btn-success btn-sm">
